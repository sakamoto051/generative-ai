...
<div class="mb-3">
  <label for="po_number" class="form-label">発注番号</label>
...
<div class="mb-3">
  <label for="supplier_id" class="form-label">取引先</label>
...
<div class="mb-3">
  <label for="delivery_due_date" class="form-label">納期 (オプション)</label>
